    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                <div class="col-6">
                    <h4>{{ $savings->savingsAccount->name }}</h4>
                </div>
                <div class="col-6">
                    <div class=" breadcrumb">
                        <div class="d-flex align-items-center">
                            <p class="mr-2">Wallet Balance: </p>
                            <h4 class="fw-bold mx-3">{{ $user->wallet->balance }} {{ $user->currency->symbol }}</h4>
                        </div>
                    </div>
                </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="user-content"> 
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex">
                                        <p class="mr-2">{{ $savings->savingsAccount->name }} Balance: </p><h4 class="fw-bold mx-3">{{ $savings->balance }} {{ $user->currency->symbol }}</h4>
                                    </div>
                                    <div class="d-flex align-items-center">
                                    ...
                                    <tbody>
                                        @foreach($transactions as $transaction)
                                            <tr>
                                                ...
                                                <td class="truncate-content">{{ $transaction->amount }} {{ $transaction->user->currency->symbol }}</td>
                                                <td> 
